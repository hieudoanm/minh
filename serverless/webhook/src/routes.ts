...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { WebhookController } from './router/webhook/webhook.controller';
  ...
  Message: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        message_id: { dataType: 'double', required: true },
      },
      validators: {},
    },
  },
  ...
  WebhookRequestBody: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        update_id: { dataType: 'double', required: true },
      },
      validators: {},
    },
  },
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(WebhookController.prototype.webhook),

    function WebhookController_webhook(request: any, response: any, next: any) {
      const args = {
        requestBody: {
          in: 'body',
          name: 'requestBody',
          required: true,
          ref: 'WebhookRequestBody',
        },
      };
      ...
      try {
        ...
        const promise = controller.webhook.apply(
          controller,
